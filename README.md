...
- **Primary stage.** Primary index: $q_i^P = v_i + a_i + \varepsilon_i$ with i.i.d. EV1 shocks. Nomination probability is multinomial logit: $\Pr(w=i \mid \mathbf v, \mathbf a) = \frac{e^{v_i+a_i}}{\sum_j e^{v_j+a_j}}.$
